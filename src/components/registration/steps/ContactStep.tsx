...
const ContactStep = ({
  ...
  return <div className={`space-y-6 ${className || ''}`}>
      ...
      <div className="pt-6 border-t border-border my-[100px]">
        <h3 className="text-lg text-foreground mb-4 md:mb-5 text-center font-bold font-sans md:text-2xl my-[100px]"><span className="text-muted-foreground text-sm font-normal">Social Media</span>
        </h3>
